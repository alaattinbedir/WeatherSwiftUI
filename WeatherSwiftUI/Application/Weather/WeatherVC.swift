...
extension WeatherVC {
    ...
    func setSunriseAndSunset() {
        guard let day = viewModel.weather?.daily?.data![0] else { return }
...
extension WeatherVC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        guard let forecastDaily = viewModel.weather?.daily?.data else { return 0 }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let data = viewModel.weather?.daily?.data![indexPath.row] else { return cell }
...
extension WeatherVC : UICollectionViewDataSource, UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        guard let forecastHourly = viewModel.weather?.hourly?.data else { return 0 }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let data = viewModel.weather?.hourly?.data![indexPath.row] else { return cell }
